                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] gap-4">
                                ...
                                <div className="flex items-center">
                                    <p className="text-black font-medium">Design Fundamentals & Color Theory</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] gap-4">
                                ...
                                <div className="flex items-center">
                                    <p className="text-black font-medium">Mastering Design Tools (Adobe Photoshop & Illustrator)</p>
                                </div>
                            </div>
