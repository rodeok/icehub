...
export default function CourseScheduleback() {
    return (
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] gap-4">
                                ...
                                <div className="flex items-center">
                                    <p className="text-black font-medium">Cybersecurity Fundamentals & Core Concepts</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] gap-4">
                                ...
                                <div className="flex items-center">
                                    <p className="text-black font-medium">Mastering Cybersecurity Tools (Wireshark & Metasploit)</p>
                                </div>
                            </div>
