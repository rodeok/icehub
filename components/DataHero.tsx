                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <h1 className="text-4xl font-bold tracking-tight !text-black sm:text-5xl md:text-6xl" style={{ color: '#000' }}>
                            Mastering Data Analytics: From Data to Decisions

                        </h1>

                        <p className="mt-8 text-lg leading-8 !text-black max-w-xl" style={{ color: '#000' }}>
                            Dive deep into the world of data with our intensive, in-person Data Analytics program. Learn to transform data into actionable insights, predict trnds,
                            and drive strategic business decisions using industry-leading tools and techniques.
                        </p>
                        ...
                        <div className="mt-10">
                            <Link
                                href="/enroll?category=data-analytics"
                    ...
                    <div className="relative">
                        <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-xl">
                            <Image
                                src="/images/data1.png" // Placeholder path, user may need to provide actual image
            ...
            <section className="bg-[#f8f9fa] py-20 px-6 lg:px-8 mt-12">
                <div className="mx-auto max-w-4xl text-center">
                    ...
                    <div className="space-y-8 text-lg leading-8 !text-black" style={{ color: '#000' }}>
                        <p>
                            Our Data Analytics course provides a robust foundation in understanding, processing, and interpreting complex datasets.
                            You will learn  to use statistical methods and powerful visualization tools to extract meaningful patterns and insights that inform critical business strategies.
                        </p>
                    </div>
                </div>
            </section>
